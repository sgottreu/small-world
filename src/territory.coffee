...
window.territories = [
    ...
    new Territory {id:4, type:'swamp', mountain:false, waterBorder:false, mountainBorder:true, edgeBorder:true, isWater:false, isMine:false, isMagic:false, isUnderworld:true, lostTribe:true, nonEmpty:true, adjacent: [3,5,9,10]}
    ...
    new Territory {id:7, type:'hill', mountain:false, waterBorder:true, mountainBorder:true, edgeBorder:false, isWater:false, isMine:false, isMagic:false, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [2,3,6,8,12,13]}
    ...
    new Territory {id:11, type:'forest', mountain:false, waterBorder:false, mountainBorder:true, edgeBorder:true, isWater:false, isMine:false, isMagic:true, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [5,10,15,16]}
    new Territory {id:12, type:'farm', mountain:false, waterBorder:false, mountainBorder:true, edgeBorder:true, isWater:false, isMine:false, isMagic:false, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [6,7,13,17,18]}
    new Territory {id:13, type:'forest', mountain:false, waterBorder:true, mountainBorder:false, edgeBorder:false, isWater:false, isMine:false, isMagic:false, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [7,8,12,14,18,19]}
    new Territory {id:14, type:'farm', mountain:false, waterBorder:true, mountainBorder:true, edgeBorder:false, isWater:false, isMine:false, isMagic:true, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [8,9,13,15,19,20,21]}
    new Territory {id:15, type:'hill', mountain:false, waterBorder:false, mountainBorder:true, edgeBorder:false, isWater:false, isMine:false, isMagic:false, isUnderworld:true, lostTribe:true, nonEmpty:true, adjacent: [9,10,11,14,16,21,22]}
    ...
    new Territory {id:17, type:'swamp', mountain:false, waterBorder:false, mountainBorder:false, edgeBorder:true, isWater:false, isMine:false, isMagic:true, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [12,18]}
    ...
    new Territory {id:19, type:'swamp', mountain:false, waterBorder:false, mountainBorder:true, edgeBorder:true, isWater:false, isMine:true, isMagic:false, isUnderworld:false, lostTribe:true, nonEmpty:true, adjacent: [13,14,18,20]}
